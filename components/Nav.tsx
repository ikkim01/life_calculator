...
const Nav = () => {
  ...
  return (
    <div className="fixed bottom-0 bg-white text-grey w-screen flex flex-col h-40 z-[2]">
      <nav className="flex justify-between px-20 items-center h-20 border-b border-t shadow-[0_-20px_-13px_rgb(0,0,0,0.03)]">
        ...
        >
          ...
          >
            <path
              ...
              stroke={menu === "favorite" ? "#30A2FF" : "#000000"}
              strokeLinecap="round"
              strokeLinejoin="round"
            />
          </svg>
          <p className={menu === "favorite" ? "text-mainBlue" : "#000000"}>
            즐겨찾기
          </p>
        </button>
        <button
        ...
        >
          ...
          >
            <g id="Menu / Hamburger_MD">
              <path
                ...
                stroke={menu === "menu" ? "#30A2FF" : "#000000"}
                strokeWidth="1"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
          ...
          <p className={menu === "menu" ? "text-mainBlue" : "#000000"}>메뉴</p>
        </button>
      </nav>
